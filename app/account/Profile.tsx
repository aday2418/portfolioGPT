...
export default async function Profile({email}: {email: string}){
    return(
        <div className="relative w-full h-[100px] flex flex-col justify-center gap-2 border-t px-[15px] border-gray-500 hover:bg-gray-900 cursor-pointer hover:border-gray-500 smoothe">
